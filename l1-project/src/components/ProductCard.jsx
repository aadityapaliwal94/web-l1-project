export default function ProductCard({product}) {
    return (
        <div className="relative hover:scale-102 transition-transform duration-300 h-120 w-100 overflow-hidden bg-black rounded-3xl text-white shrink-0">                                                                
            <img className="h-full w-full" src={product.url}/>                            
