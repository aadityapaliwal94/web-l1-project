                    ...
                    <div className="px-30 pb-10 flex gap-60">
                        ...
                        <div>
                            ...
                            <ul className="pl-1 mt-5">
                                <a className="cursor-pointer" href="/"><li className="pb-5 hover:text-red-400 hover:underline underline-offset-8">Home</li></a>
                                <a className="cursor-pointer" href="/"><li className="pb-5 hover:text-red-400 hover:underline underline-offset-8">Store</li></a>
                                <a className="cursor-pointer" href="/"><li className="pb-5 hover:text-red-400 hover:underline underline-offset-8">About Us</li></a>
                                <a className="cursor-pointer" href="/"><li className="pb-5 hover:text-red-400 hover:underline underline-offset-8">Contact Us</li></a>                                
                            </ul>
                        </div>
                        <div>
